...
class studentManager {
        ...
        addStudents(name :string ) {
            ...
            console.log(chalk.bold.italic.bgGray
                (`Student: ${name} added successfully with the Student Id : ${stdName.Id}`));
        ...
        enrollStudent(studentId:number, course:string) {
            ...
            if(student) {
                ...
                console.log(chalk.bold.italic.bgCyan(`Congratulations! ${student.name} enrolled in course: ${course} successfully.`));
            }
        }
